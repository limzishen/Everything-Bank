...
## DSA/Algo Interview Prep:
  ...
  Doing:
  4. Neetcode.io -  https://neetcode.io/practice (Do the neetcode 150)
  5. Leetcode - https://leetcode.com/ (obvious but needed, do contests on weekends to build up the skill to solve qs under time pressure)
  6. CSES Problem set - https://cses.fi/problemset/list (Harder than LC but will make you better)
...
## System Design:
  ...
  Watching
  2. Grokking Modern System Design Interview - Educative.io (Can finish it quite quickly, pair that with practising random cases with a friend)
